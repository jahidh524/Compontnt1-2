            ...
            drawer: Drawer(
              child: ListView(
                children:  [
                  ...
                  const ListTile(
                    title: Text('Option 1',style: TextStyle(fontSize: 20, color: Colors.green)),
                    
                  ),
                  const ListTile(
                    title: Text('Option 2',style: TextStyle(fontSize: 20, color: Colors.green)),
                  ),
                  const ListTile(
                    title: Text('Option 3',style: TextStyle(fontSize: 20, color: Colors.green)),
                  ),
                  const ListTile(
                    title: Text('Option 4',style: TextStyle(fontSize: 20, color: Colors.green)),
                  ),
